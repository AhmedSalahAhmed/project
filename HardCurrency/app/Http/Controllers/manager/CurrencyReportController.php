    ...
    public function searchprocess(Request $request)
    {
        ...
        if ($request->start_at != '' && $request->end_at != '') {
            ...
            return view('manager.reports.processes', compact('processes', 'employees', 'currencies', 'branches', 'banks', 'start_at', 'end_at'))->withDetails($processes);
                ...
                return view('manager.reports.processes', compact('processes', 'employees', 'currencies', 'branches', 'banks', 'start_at', 'end_at'))->withDetails($processes)->with('i', (request()->input('page', 1) - 1) * 1);
            }
        }
    }
