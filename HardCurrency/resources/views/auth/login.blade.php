...
<head>
    ...
    <title>بنك السودان المركزي</title>
        ...
        <div class="container rtl">
            <div class="card login-card">
                <div class="row no-gutters">
                    <div class="col-md-5">
                        <img src="assets/images/Sudan-Central-Bank.jpg" alt="login" class="login-card-img">
                    </div>
                        ...
                        <div class="card-body shadow">
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="brand-wrapper">
                                    <p class="login-card-description" style="text-align: center;"> بنك السودان المركزي</p>
